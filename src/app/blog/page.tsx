    ...
    <div className="flex flex-col min-h-screen bg-brand-white">
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto w-full">
          ...
          <ScrollReveal delay={150}>
            <div className="bg-white border-2 border-gray-100 rounded-2xl overflow-hidden shadow-sm md:hover:shadow-[0_20px_50px_-12px_rgba(179,0,89,0.15)] md:hover:border-brand-pink/30 md:hover:-translate-y-2 active:scale-[0.98] active:bg-gray-50 transition-all duration-500 group flex flex-col md:flex-row cursor-pointer">
              ...
              <div className="w-full md:w-1/2 min-h-[300px] md:min-h-[400px] relative overflow-hidden bg-gray-100">
                <div className="absolute inset-0">
                  <Image 
                    ...
                    fill
                    className="object-cover object-top md:group-hover:scale-105 transition-transform duration-700"
              ...
              <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-4 md:group-hover:text-brand-pink transition-colors duration-300">
                ...
                <Link href="#" className="inline-flex items-center gap-2 text-brand-blue font-bold md:hover:text-brand-pink transition-colors duration-300 w-fit">
                  Read Full Article
        ...
        <div className="border-t border-gray-200 pt-16">
          <ScrollReveal delay={0}>
            <h2 className="text-2xl font-bold text-brand-blue mb-10 text-center md:text-left">
              Recent Publications
            </h2>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {posts.map((post, index) => (
              <ScrollReveal delay={index * 150} key={post.id}>
                <div className="bg-white border border-gray-200 p-8 rounded-xl md:hover:shadow-[0_15px_40px_-10px_rgba(179,0,89,0.12)] md:hover:-translate-y-2 md:hover:border-brand-pink/30 active:scale-[0.98] active:bg-gray-50 transition-all duration-500 group flex flex-col h-full cursor-pointer">
                  ...
                  <div className="flex items-center justify-between text-sm border-t border-gray-100 pt-4 mt-auto">
                    ...
                    <span className="text-brand-blue font-medium md:group-hover:text-brand-pink transition-colors">{post.readTime}</span>
                  </div>
