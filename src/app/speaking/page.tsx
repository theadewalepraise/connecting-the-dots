    ...
    <div className="flex flex-col min-h-screen bg-brand-white">
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 bg-white border border-gray-200 hover:border-brand-blue/30 rounded-xl shadow-sm hover:shadow-[0_15px_40px_-10px_rgba(0,51,102,0.12)] hover:-translate-y-2 transition-all duration-500 group cursor-pointer">
            <div className="text-brand-blue group-hover:text-brand-pink transition-all duration-500 mb-6 transform group-hover:scale-110 origin-left">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-brand-blue transition-colors duration-300">The Education-to-Workforce Pipeline</h3>
          ...
          <div className="p-8 bg-white border border-gray-200 hover:border-brand-blue/30 rounded-xl shadow-sm hover:shadow-[0_15px_40px_-10px_rgba(0,51,102,0.12)] hover:-translate-y-2 transition-all duration-500 group cursor-pointer">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-brand-blue transition-colors duration-300">Equity in Action</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="p-8 bg-white border border-gray-200 hover:border-brand-blue/30 rounded-xl shadow-sm hover:shadow-[0_15px_40px_-10px_rgba(0,51,102,0.12)] hover:-translate-y-2 transition-all duration-500 group cursor-pointer">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-brand-blue transition-colors duration-300">Shaping National Policy</h3>
            <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-20 px-6 bg-gray-50 border-t border-gray-200">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-10 md:p-16 text-center">
          ...
          <Link 
            href="/contact" 
            className="inline-flex items-center gap-3 bg-brand-pink text-brand-blue font-bold px-10 py-4 rounded-md hover:bg-brand-blue hover:text-brand-white hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group"
          >
